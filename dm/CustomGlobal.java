...
//		// nodes
//		sinalgo.tools.Tools.removeAllNodes();
//		AllNode [][] theNodes = new AllNode[length][width];
//				
...
//
//		// nodes
//		AllNode [][] theNodes = new AllNode[degree][numStages];
//		AllNode center;
//		
//		// the center
...
//				if (i ==  numStages && j == 0) node = new AllNode();
//				else if (i ==  numStages && j == degree / 2) node = new AllNode();
//				else node = new AllNode();
//				node.setPosition(posX, posY, 0);
//				node.finishInitializationWithDefaultModels(true);
//				theNodes[j][i-1] = node;
...
//		sinalgo.tools.Tools.removeAllNodes();
//		ArrayList<AllNode> nodes = new ArrayList<AllNode>();
//
//		// the root
...
//			posX = initPosX;
//			for(int j = 0; j < degree; j++){	
//				if (i == numStages - 1 && j == 0) node = new AllNode();
//				else if (i == numStages -1 && j == degree - 1) node = new AllNode();
//				else node = new AllNode();
//				node.setPosition(posX, posY, 0);
//				node.finishInitializationWithDefaultModels(true);
